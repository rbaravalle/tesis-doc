...
Respecto de este último punto, se extenderá la investigación sobre texturas multi-resolución, como fue planteado en la sección de renderizado.
Las texturas multi-resolución permiten un ahorro en memoria considerable, ya que dependiendo de diversos factores del renderizado, como por ejemplo la posición de la cámara, podrían utilizarse texturas con mayor o menor detalle (está técnica es similar a {\em mipmapping}, es decir, construir diversas texturas a partir de una única muestra).
