...
\centering{\includegraphics[scale = 0.3]{../figures/ratatouille}}
...
\begin{frame}
La intersección de las burbujas produce una estructura que no es necesariamente fractal
...
\begin{frame}{Cocción}
Modelo unidimensional (Transferencia de calor y masa)
