...
Un texel es una {\em estructura de datos} volumétrica que asocia tres componentes: una densidad de área proyectada $\rho$, un conjunto de cuadros $\bold{B}$ y un modelo bidireccional de reflexión de la luz $\psi$, a cada posición $3D$ del espacio.
...
En \cite{Kajiya1989} se utiliza un enfoque volumétrico para renderizar pelo.
