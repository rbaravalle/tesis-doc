...
Esta Tesis fue desarrollada gracias a la ayuda económica del Consejo Nacional de Investigaciones Científicas y Técnicas (CONICET) mediante becas tipo I (abril 2011-marzo 2014) y II (abril 2014 - abril 2016), y con subsidios PGI 24/K060 del proyecto SECyT-UNS.
...
Esto se debe, en gran medida, a dos factores: por un lado, la teoría matemática que describe la distribución de luz en una escena fue aproximada en computación gráfica hace ya tres décadas, y por otro, la evolución del hardware gráfico ha sufrido un aumento exponencial en poder de cómputo, permitiendo aproximar la teoría mencionada a tasas de refresco interactivas o de tiempo real.
Los objetos que componen una escena están a su vez compuestos por diversos materiales, los cuales deben ser tratados en detalle, para que su apariencia asemeje los objetos reales.

A lo largo de los años, los materiales más ubicuos en escenas fueron los que recibieron mayor atención (agua, nubes, piel humana, etc.), sin embargo muchos materiales, debido a su complejidad estructural (geometría, estado de la materia), o su complejo comportamiento con la luz (reflectancia, absorción, translucencia), han sido ignorados, o tratados superficialmente.
Entre estos materiales, los materiales porosos, como pan, esponjas y huesos; y cocidos, como (nuevamente) pan, pizzas, tortas, etc., han sido especialmente dificultosos, dada la familiaridad que los seres humanos poseen con dichos materiales.
En otras palabras, los modelos que no se ajusten fuertemente a los materiales reales serán reconocidos con facilidad, y por lo tanto deben diseñarse muy precisamente.
...
Luego, los resultados se generalizaron a tres dimensiones, con el objetivo de obtener volúmenes representado geometrías porosas, donde el crecimiento de las partículas se guía por medio de sistemas dinámicos.
Los resultados son promisorios, resultando en un procedimiento flexible, con el poder de representar diversidad de estructuras porosas, como esponjas y pan, sin presentar las limitaciones de un tratamiento de superficie, por ejemplo, la imposibilidad de realizar cortes arbitrarios.
...
Estos resultados resultan promisorios, y útiles para su extensión a otros materiales.
...
Last decades have witnessed the unprecedent evolution in photo-realistic scene modeling and rendering.
Causes are twofold: on the one hand, the mathematical theory that describes light distribution over a scene was already approximated in Computer Graphics three decades from now, on the other hand, the evolution in the computing capabilities of graphics hardware increased exponentially.
This computing power enabled to approximate the computations at interactive or real time frame rates.

The objects in a scene encompasses several materials, which should be carefully designed to appear realistic.
Over the years, the most predominant materials received great attention (water, fire, clouds, skin, etc.), but several other materials, either based on its structural complexity, or its complex light interaction (reflectance, translucency, absorption), has been largely ignored, or only superficially treated.
Among these materials, those that show porous geometries such as sponges, bread or bones, and those that results from a cooking process, such as bread (again), cakes, pizzas, and cookies, has been specially tricky to tackle, given humans are specially prepared to spot improper models.

This Thesis deals with the simulation, modelization and rendering of these materials.
...
Results are promising, obtaining a flexible procedure with the ability of represent several porous geometries, as sponges and bread, withouth showing the limitations of a surface treatment, as for instance, the impossibility of getting arbitrary cuts of the material
...
Also the multifractal dimensions showed to be useful in bread crumb characterization and classification (porosity, mean cell area, etc.), and its classification, obtaining better results than other state-of-the-art features.
