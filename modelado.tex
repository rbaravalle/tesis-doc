...
Un sub-producto importante de la matriz que representa la geometría está dado por una textura volumétrica secundaria, resultante de aplicarle a la anterior una transformación de distancia.
...
La geometría introducida se voxeliza, de la forma descripta en la sección anterior, para proceder a las siguientes etapas.
...
Las distribuciones de temperaturas son cualitativamente similares a lo que se obtendría con una simulación $3D$~\cite{Purlis2010}, ver Fig.~\ref{fg:purlistemp}.

\begin{figure*}
\centerline{\includegraphics[width=6cm]{figures/purlistemp}}
\caption[Distribución de temperaturas resultante de un modelo físico tridimensional del pan]{Distribución de temperaturas resultante de un modelo físico tridimensional del pan (imagen tomada de \cite{Purlis2010}).}
\label{fg:purlistemp}
\end{figure*}
...
$$P[x,y,z] = m\acute{a}x \bigg\{r\bigg\},$$

\noindent donde $r$ es el radio de una burbuja que ocurre en la entrada $[x,y,z]$.
El término $m\acute{a}x$ en el cómputo retiene el máximo radio que ocurre en la entrada $[x,y,z]$.
...
Los modelos introducidos resultan más flexibles y poderosos que aquellos del estado del arte actual en modelado de geometría de materiales porosos.
